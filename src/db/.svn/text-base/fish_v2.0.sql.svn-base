...
CREATE TABLE `fish_fubi_type` (
  ...
  `point` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '增加的富币数',
  PRIMARY KEY (`id`)
...
CREATE TABLE `fish_goods` (
  ...
  `priceRange` varchar(64) NOT NULL DEFAULT '' COMMENT '商品价格区间',
  `pictures` varchar(255) NOT NULL DEFAULT '' COMMENT '商品图片',
  `title` varchar(256) NOT NULL DEFAULT '' COMMENT '展示的title',
  `detail` varchar(1024) NOT NULL DEFAULT '' COMMENT '商品详情',
  `enable` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0待审核，1审核通过',
...
-- ----------------------------
INSERT INTO `fish_goods` VALUES ('1', '1', '30.00000', '1', '科迈雷三色多款三竿稍枪柄路亚竿套装水滴轮钓鱼竿', '', '1', '0', '200', '0', '0', '', '2015-12-11 10:35:11', '3', '0', '1', '10', '1', '1', '1', '50');
...
-- ----------------------------
INSERT INTO `fish_goods_category` VALUES ('1', '0', '1', '鱼竿');
INSERT INTO `fish_goods_category` VALUES ('2', '1', '1', '台钓竿');
INSERT INTO `fish_goods_category` VALUES ('3', '1', '0', '路亚竿');
INSERT INTO `fish_goods_category` VALUES ('5', '2', '0', '鲤竿');
INSERT INTO `fish_goods_category` VALUES ('6', '0', '1', '鱼饵');
INSERT INTO `fish_goods_category` VALUES ('7', '6', '0', '草鱼饵');
INSERT INTO `fish_goods_category` VALUES ('8', '6', '0', '鲤鱼饵');
...
CREATE TABLE `fish_goods_keyt_params` (
  ...
  `parentVID` mediumint(8) NOT NULL DEFAULT '0' COMMENT '父特征量id',
  `hasChild` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否含有子特征量，0：没有；1：有',
...
-- ----------------------------
INSERT INTO `fish_goods_keyt_params` VALUES ('1', '5', '0', '0', '颜色', '1');
INSERT INTO `fish_goods_keyt_params` VALUES ('2', '5', '0', '0', '长度', '2');
INSERT INTO `fish_goods_keyt_params` VALUES ('3', '7', '0', '0', '重量', '3');
INSERT INTO `fish_goods_keyt_params` VALUES ('4', '3', '0', '0', '颜色', '4');
INSERT INTO `fish_goods_keyt_params` VALUES ('5', '3', '0', '0', '长度', '5');
INSERT INTO `fish_goods_keyt_params` VALUES ('6', '8', '0', '0', '重量', '6');
...
INSERT INTO `fish_goods_keyt_params_value` VALUES ('3', '1', '黑', '3');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('4', '1', '白', '4');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('5', '2', '3.0m', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('6', '2', '4.5m', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('7', '2', '6.5m', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('8', '3', '0.2kg', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('9', '3', '0.5kg', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('10', '3', '0.7kg', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('11', '4', '紫', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('12', '4', '绿', '0');
INSERT INTO `fish_goods_keyt_params_value` VALUES ('13', '4', '蓝', '0');
...
CREATE TABLE `fish_goods_nonkeyt_params` (
  `id` mediumint(8) NOT NULL COMMENT '类型对应的参数自增长id',
...
CREATE TABLE `fish_goods_nonkeyt_params_value` (
  `goodsId` mediumint(8) NOT NULL COMMENT '商品id',
  `paramsId` mediumint(8) NOT NULL COMMENT '参数id',
  `value` varchar(255) NOT NULL COMMENT '参数内容',
  PRIMARY KEY (`goodsId`,`paramsId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of fish_goods_nonkeyt_params_value
-- ----------------------------
INSERT INTO `fish_goods_nonkeyt_params_value` VALUES ('1', '1', '10m');
...
CREATE TABLE `fish_harvest` (
  ...
  `address` varchar(255) NOT NULL DEFAULT '' COMMENT '发布地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fish_mall_seckill_goods` (
  ...
  `ramain` int(10) unsigned NOT NULL COMMENT '剩余数量',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='自媒体';
...
CREATE TABLE `fish_news_comment` (
  ...
  `comments` mediumint(8) NOT NULL COMMENT '评论数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_icelandic_ci;
...
CREATE TABLE `fish_order` (
  ...
  `dateline` time NOT NULL COMMENT '创建时间',
  `price` decimal(15,5) NOT NULL DEFAULT '0.00000' COMMENT '订单价格',
  `uid` mediumint(8) NOT NULL DEFAULT '0' COMMENT '用户id',
  `status` mediumint(8) NOT NULL DEFAULT '0' COMMENT '订单状态，0：待付款；1：待发货；2：待签收；3：已签收；4：退款审核；5：已取消',
...
CREATE TABLE `fish_shopping_cart` (
  ...
  `datetime` time NOT NULL COMMENT '加入购物车时间',
...
CREATE TABLE `fish_shop_count` (
  ...
  `nonPostage` decimal(15,5) NOT NULL DEFAULT '0.00000' COMMENT '包邮价格',
  `postagePrice` decimal(15,5) unsigned NOT NULL DEFAULT '0.00000' COMMENT '邮费',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fish_user_count` (
  ...
  `follower` mediumint(8) DEFAULT NULL COMMENT '粉丝人数',
...
-- ----------------------------
INSERT INTO `fish_user_follow` VALUES ('1', '2', null);
INSERT INTO `fish_user_follow` VALUES ('1', '3', null);
INSERT INTO `fish_user_follow` VALUES ('2', '1', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=475 DEFAULT CHARSET=utf8 COMMENT='授权';
...
INSERT INTO `sec_authority_resource` VALUES ('448', '496');
INSERT INTO `sec_authority_resource` VALUES ('444', '445');
INSERT INTO `sec_authority_resource` VALUES ('444', '498');
...
CREATE TABLE `sec_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COMMENT='菜单资源';
...
INSERT INTO `sec_menu` VALUES ('56', '', '比赛管理', '0', '', '', '8');
...
INSERT INTO `sec_menu` VALUES ('69', '学院获奖审核', '获奖审核', '0', '', '', '6');
...
INSERT INTO `sec_menu` VALUES ('72', '学校赛前审核', '竞赛审核', '0', '', 'recordPreVerify', '5');
INSERT INTO `sec_menu` VALUES ('73', '获奖学生录入信息', '我的成果', '56', '', 'recordwinList', '60');
INSERT INTO `sec_menu` VALUES ('74', '学校获奖审核', '获奖审核', '0', '', '', '7');
...
) ENGINE=InnoDB AUTO_INCREMENT=508 DEFAULT CHARSET=utf8 COMMENT='具体资源';
...
INSERT INTO `sec_resource` VALUES ('498', 'newscategory', '/tech/newsCategory/add/**;/tech/newsCategory/save/**;/tech/newsCategory/update/**;/tech/newsCategory/delete/**;/tech/newsCategory/edit/**;', null, '0');
...
INSERT INTO `sec_role` VALUES ('6', '学院管理员', '学院级审核，查询，驳回');
INSERT INTO `sec_role` VALUES ('7', '学校级管理员', '学校级审核');
...
INSERT INTO `sec_role_authority` VALUES ('7', '473');
INSERT INTO `sec_role_authority` VALUES ('7', '471');
INSERT INTO `sec_role_authority` VALUES ('7', '467');
...
INSERT INTO `sec_role_authority` VALUES ('6', '473');
INSERT INTO `sec_role_authority` VALUES ('6', '469');
...
CREATE TABLE `sec_user` (
  ...
  `instrest` varchar(1024) NOT NULL DEFAULT '' COMMENT '兴趣爱好',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='通用用户表';

-- ----------------------------
-- Records of sec_user
-- ----------------------------
INSERT INTO `sec_user` VALUES ('1', '0', 'tuanwei', '系统管理员', '管理员', '', '444637e6b45cca515e0f1d3a593ce32ad3e81f20', 'tuanwei123456', '100', '', '1', '510228196325146579', '', '', '', '', '', '', '1', '0fb99ddcccd289ea', '0', '0000-00-00 00:00:00', '2015-11-30 19:02:57', '1', '', '');
