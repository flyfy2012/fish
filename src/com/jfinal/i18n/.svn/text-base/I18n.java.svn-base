 ...
 * <p>
 * Example:<br>
 * 1: Create resource file "demo_zh_CN.properties" content with: msg=你好 JFinal!
 * 你好{0}! <br>
 * Create resource file "demo_en_US.properties" content with: msg=Hello JFinal!
 * Hello {0}! <br>
 * <br>
 * 
 * 2: Res res = I18n.use("demo", "zh_CN");<br>
 * res.get("msg"); // return value: 你好 JFinal! 你好{0}!<br>
 * res.format("msg", "詹波"); // return value: 你好 JFinal! 你好詹波!<br>
 * <br>
 * 
...
public class I18n {
	...
	static String defaultLocale = Locale.getDefault().getLanguage() + "_"
	...
	/**
	 * Using the base name and locale to get the Res object, which is used to
	 * get i18n message value from the resource file.
	 * 
	 * @param baseName
	 *            the base name to load Resource bundle
	 * @param locale
	 *            the locale string like this: "zh_CN" "en_US"
	 * @return the Res object to get i18n message value
	 */
	public static Res use(String baseName, String locale) {
		String resKey = baseName + "_" + locale;
		System.out.println(locale);
		System.out.println("我在I18n中修改了：获取当前资源名为");
