...
public class I18nInterceptor implements Interceptor {
	...
	public  static String locale =Preference.locale;
;
	...
	public void intercept(Invocation inv) {
		...
		System.out.println("当前的Controller是-------->"+c.toString());
	
		//String locale = c.getPara(localePara);  //从request中获取locale属性，即地点
		
		System.out.println(c.getPara("language"));
		if(c.getPara("language")!=null){
			
			Preference.locale=c.getPara("language");
			locale=Preference.locale;
			System.out.println("当前的语言是---------------》》》"+locale);
...
//		}
		...
		if (isSwitchView) {
		  switchView(locale, c);
			System.out.println("需要更改的國際化太多就需要準備多個Html來更改视图");
		}
		else {
